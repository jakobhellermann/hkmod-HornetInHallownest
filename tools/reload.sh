...
#   2. dotnet build -> the csproj copies the DLL into Managed/Mods/HornetInHallownest/ -> the modding API hot-reloads
...
SRC="/home/jakob/dev/hk/mods/HornetInHallownest/Source"
...
echo "building..."
if ! dotnet build "$SRC/HornetInHallownest.csproj" >"$BUILDLOG" 2>&1; then
    echo "build FAILED:"
